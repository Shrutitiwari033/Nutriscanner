...
def get_health_impact(user_data, nutrition_info):
    ...
    headers = {
        "Authorization": "Bearer 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",
    }
...
with tabs[0]:
    ...
    if display_image is not None:
        st.image(display_image, caption="Captured/Uploaded Image", use_column_width=True)
